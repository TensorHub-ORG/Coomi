import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@coomi/cordis-plugin-loader'
 ...
 * (`coomi --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`coomi --dump-config`) so a dump can never drift from what boots. The input

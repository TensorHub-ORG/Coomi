import { Context, Service, type Plugin } from '@coomi/cordis'
import type { Dict } from '@coomi/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@coomi/cordis-plugin-loader'
import type { Include } from '@coomi/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@coomi/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [coomi-desktop] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`

/**
 * Unit + real-load-path coverage for @coomi/coomi-tool-call-timeout-policy. The
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@coomi/coomi-tools'
import * as timeoutPolicy from '@coomi/coomi-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@coomi/coomi-tool-call-timeout-policy'
...
describe('coomi-tool-call-timeout-policy real-load-path guard', () => {

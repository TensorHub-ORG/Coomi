 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in coomi-llm (tool-call
 * correlation), the shared agent/session `SessionId` in coomi-session, and
 * `JobId` in coomi-jobs. Branding is for ids that cross package boundaries and

/**
 * Real-load-path guard for @coomi/coomi-mcp-client. `mcp-client` is a
...
import * as mcpClient from '@coomi/coomi-mcp-client'

describe('coomi-mcp-client real-load-path guard', () => {

/**
 * End-to-end tests for coomi-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@coomi/coomi-mcp-client/src/index.ts'
import { publicToolName } from '@coomi/coomi-mcp-client/src/tools.ts'

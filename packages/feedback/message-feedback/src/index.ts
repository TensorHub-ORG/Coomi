 ...
 * @module @coomi/coomi-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@coomi/cordis'
import s from '@coomi/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@coomi/coomi-session/surface'
import type { SessionHeader, SessionId } from '@coomi/coomi-session/types'
import type { SessionInspection } from '@coomi/coomi-session-persistence'
import type { KvTable } from '@coomi/coomi-storage-domain'
import { TypertRemoteService, Remote } from '@coomi/coomi-typert-protocol'

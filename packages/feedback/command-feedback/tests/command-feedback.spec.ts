...
import SessionStore, { foldSurface, Session, SessionId } from '@coomi/coomi-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@coomi/coomi-session-telemetry'
...
vi.mock('@coomi/coomi-anonymous-user-id', () => ({
...
describe('@coomi/coomi-command-feedback registration', () => {

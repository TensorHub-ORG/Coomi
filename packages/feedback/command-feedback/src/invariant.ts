/**
 * Package-owned invariant companion for `@coomi/coomi-command-feedback`.
 * @module @coomi/coomi-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-command-feedback'

...
} from '@coomi/coomi-attachment'
import LlmRuntime, { createUserMessage, CallId } from '@coomi/coomi-llm'
import type { Message, ToolSchema } from '@coomi/coomi-llm'
import * as LlmPiAi from '@coomi/coomi-llm-pi-ai'
...
const openAIBaseURL = process.env.COOMI_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.COOMI_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.COOMI_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.COOMI_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',

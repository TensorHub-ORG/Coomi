 ...
 *
 * @module coomi-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@coomi/coomi-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@coomi/coomi-llm'
import { attributionHeaders } from '@coomi/coomi-llm'
 ...
 * on the length the server claims — the same two-stage shape `coomi-web-fetch`

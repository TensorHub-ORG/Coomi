/** Package-owned durable retry-event invariants. @module @coomi/coomi-llm-retry/invariant */

import type { Context } from '@coomi/cordis'
import type { Session, SessionEvent } from '@coomi/coomi-session'
import type { LlmFailure } from '@coomi/coomi-llm'
...
const PACKAGE_NAME = '@coomi/coomi-llm-retry'

 ...
 *
 * @module coomi-llm-deepseek/adapter
 */

import { attributionHeaders, CONTEXT_WINDOW_EXCEEDED_CODE, isContextWindowExceededError, isQuotaExceededError, LlmAdapter, LlmError, ProviderRequestId, QUOTA_EXCEEDED_CODE, ReasoningEffortId } from '@coomi/coomi-llm'
import type {
  GenerateOptions,
  LlmModelInfo,
  LlmProviderInfo,
...
import { idleWatchdog, timeoutOf } from '@coomi/coomi-timeout'
import type { AnonymousUserId } from '@coomi/coomi-anonymous-user-id'
...
export class DeepSeekAdapter extends LlmAdapter {
  ...
  private async * request(
    ...
    const headers = {
      ...
      ...attributionHeaders(),
      'x-coomi-desktop-user-id': String(userId),
      ...options.sessionId !== undefined
        ? { 'x-coomi-desktop-session-id': String(options.sessionId) }
        : {},
      ...options.purpose === 'compaction'
        ? { 'x-coomi-desktop-compact': '1' }
        : {},
    }

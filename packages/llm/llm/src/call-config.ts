 ...
 * @module coomi-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by coomi-agent-loop. */
...
/**
 * Mark one exact request object as assembled by coomi-agent-loop.
...
/**
 * Test whether the exact request object was assembled by coomi-agent-loop.

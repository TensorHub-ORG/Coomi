 ...
 * @module @coomi/coomi-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@coomi/coomi-llm'
import { SessionId } from '@coomi/coomi-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@coomi/coomi-tools'
import type { ObjectJsonSchema } from '@coomi/coomi-tools'
import { isFatalWorkflowError, WorkflowError } from '@coomi/coomi-workflow'
import type {

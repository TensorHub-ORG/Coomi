/**
 * Package-owned invariant companion for `@coomi/coomi-workflow-worker-thread`.
 * @module @coomi/coomi-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-workflow-worker-thread'

/**
 * Package-owned invariant companion for `@coomi/coomi-client-test-runtime`.
 * @module @coomi/coomi-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-test-runtime'

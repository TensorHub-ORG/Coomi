 ...
 *
 * Not part of the product plugin graph (no `coomi.client`); feature packages
 ...
 * @module @coomi/coomi-client-test-runtime
 */
...
import { Context, Inject } from '@coomi/cordis'
import type { Fiber, Plugin } from '@coomi/cordis'

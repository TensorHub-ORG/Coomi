/**
 * Package-owned invariant companion for `@coomi/coomi-agent-loop-testkit`.
 * @module @coomi/coomi-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-agent-loop-testkit'

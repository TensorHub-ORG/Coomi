/**
 * Package-owned invariant companion for `@coomi/coomi-llm-mock-server`.
 * @module @coomi/coomi-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-llm-mock-server'

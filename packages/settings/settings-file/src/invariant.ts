/**
 * Package-owned invariant companion for `@coomi/coomi-settings-file`.
 * @module @coomi/coomi-settings-file/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@coomi/coomi-settings`.
 */

/**
 * Package-owned invariant companion for `@coomi/coomi-sdk-jsonrpc-server`.
 * @module @coomi/coomi-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-sdk-jsonrpc-server'

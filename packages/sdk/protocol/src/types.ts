/**
 * Named wire types for the Coomi SDK runtime protocol: the three
 * request/result pairs and the four server-to-client notification payloads
 * exchanged over the newline-delimited JSON-RPC stdio transport. The server
 * plugin (`@coomi/coomi-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `coomi-desktop-sdk-runtime`.
 *
 * @module @coomi/coomi-sdk-protocol/types
 */

import type { ContentBlock } from '@coomi/coomi-llm'
import type { SessionEvent } from '@coomi/coomi-session'
import type { SubagentStopReason } from '@coomi/coomi-subagent'
...
export interface InitializeResult {
  /** Wire-stable server identity (`coomi-desktop-sdk-runtime`) and version. */

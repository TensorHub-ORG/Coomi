/**
 * @coomi/coomi-cmdline — the command line a coomi launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `coomi --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */

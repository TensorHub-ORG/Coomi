 ...
 *
 * @module @coomi/coomi-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@coomi/node-addon-landlock-run'
 ...
 * (`@coomi/coomi-fs-sandbox`) can never drift apart.

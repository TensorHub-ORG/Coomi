 ...
 * `@coomi/coomi-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @coomi/coomi-pwsh-sandbox
 */
...
import { SandboxUnavailableError } from '@coomi/coomi-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,

/**
 * Shared rendering helpers for the shell tools (`coomi-tool-bash`,
 * `coomi-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @coomi/coomi-shell/render
 */

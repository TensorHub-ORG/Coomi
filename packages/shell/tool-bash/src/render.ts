 ...
 *
 * @module @coomi/coomi-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@coomi/coomi-shell'
import type { SandboxMode } from '@coomi/coomi-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@coomi/coomi-sandbox'
 ...
 * rendering story, owned by `@coomi/coomi-shell` so `coomi-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@coomi/coomi-shell'

 ...
 * twin of `coomi-tool-bash`'s background adaptation.
 *
 * @module @coomi/coomi-tool-pwsh/background
 */

import type { ShellProcess } from '@coomi/coomi-shell'

/* jscpd:ignore-start -- deliberate twin of coomi-tool-bash/background.ts (Agent Note). */

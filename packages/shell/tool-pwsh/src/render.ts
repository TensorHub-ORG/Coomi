 ...
 * `coomi-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @coomi/coomi-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@coomi/coomi-shell'
import type { SandboxMode } from '@coomi/coomi-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@coomi/coomi-sandbox'

/* jscpd:ignore-start -- deliberate twin of coomi-tool-bash/render.ts (Agent Note). */

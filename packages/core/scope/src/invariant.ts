/** Package-owned scoped-dispatch invariants. @module @coomi/coomi-scope/invariant */

import type { Context } from '@coomi/cordis'
import type { InvariantInstaller } from '@coomi/coomi-invariants'
import { carrierKeyOf, isScopeCarrier } from '@coomi/coomi-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@coomi/coomi-scope'

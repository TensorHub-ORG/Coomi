 ...
 *
 * @module @coomi/coomi-session
 */

import { Context, Service } from '@coomi/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@coomi/coomi-llm'
import { scopeOf, scopeTarget } from '@coomi/coomi-scope'
import type { Scoped } from '@coomi/coomi-scope'
import type { Message } from '@coomi/coomi-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@coomi/coomi-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@coomi/coomi-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@coomi/coomi-session#Session',

 ...
 * @module @coomi/coomi-agent-loop/invariant
 */

import type { Context } from '@coomi/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@coomi/coomi-llm'
import type { InvariantFailure, InvariantInstaller } from '@coomi/coomi-invariants'
import { foldRequestHeader } from '@coomi/coomi-session'

const PACKAGE_NAME = '@coomi/coomi-agent-loop'

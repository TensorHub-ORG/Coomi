 ...
 * ([`coomi-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @coomi/coomi-agent-tool-presentation
 */

import type { Context } from '@coomi/cordis'
import z from '@coomi/schemastery'
import type { ToolPresentationMode } from '@coomi/coomi-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `coomi-agent-presets` reports as an unusable row, naming this id.

/**
 * Package-owned invariant companion for `@coomi/coomi-agent-tool-presentation`.
 * @module @coomi/coomi-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-agent-tool-presentation'
 ...
 * registry's to hold, and `coomi-tools` observes it there.
 */

/**
 * Package-owned invariant companion for `@coomi/coomi-cordis-host-runner`.
 * @module @coomi/coomi-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-cordis-host-runner'

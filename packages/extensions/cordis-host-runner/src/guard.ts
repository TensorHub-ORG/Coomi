 ...
 * @module @coomi/coomi-cordis-host-runner/guard
 */

import { Context } from '@coomi/cordis'
import type { Plugin } from '@coomi/cordis'
import { scopeOf } from '@coomi/coomi-scope'
import { assertSupportedJsonSchema, defineTool } from '@coomi/coomi-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@coomi/coomi-cordis-client-runner`, whose CTX_VERBS names this one its

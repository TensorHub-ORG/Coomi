/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-cordis`.
 * @module @coomi/coomi-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-cordis'

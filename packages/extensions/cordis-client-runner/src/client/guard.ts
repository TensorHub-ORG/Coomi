...
import type { DynamicCordisPackage } from '@coomi/coomi-api-remotes/client'
import type { SlotRegistry } from '@coomi/coomi-client-runtime/client'
import type { ThemeRuntime } from '@coomi/coomi-client-ui-theme/client'
      ...
      return (source: unknown, tokens: unknown): unknown => {
        ...
        if (tokens === undefined && typeof source === 'object' && source !== null) {
          return rejectGuard(env,
            ...
            + 'so pass any string first and the token map second: overrideTokens(\'mine\', { \'--coomi-alias-…\': { light: \'…\', dark: \'…\' } })',
          )
        }

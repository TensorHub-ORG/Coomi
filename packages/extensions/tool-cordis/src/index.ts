 ...
 * @module @coomi/coomi-tool-cordis
 */
...
} from '@coomi/coomi-cordis-host-runner'
import type { DynamicCordisReference } from '@coomi/coomi-cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the coomi process restarted.',

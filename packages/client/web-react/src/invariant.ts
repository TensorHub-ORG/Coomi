/**
 * Package-owned invariant companion for `@coomi/coomi-client-web-react`.
 * @module @coomi/coomi-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-web-react'

/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-subagent`.
 * @module @coomi/coomi-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-subagent'

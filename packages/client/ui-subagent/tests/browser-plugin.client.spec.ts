...
import type { ComposerChainProps } from '@coomi/coomi-client-ui-conversation/client'
import { InputTriggerService } from '@coomi/coomi-client-ui-input-trigger/client'
import type { ClientSessionContext, InputTriggerSource } from '@coomi/coomi-client-ui-input-trigger/client'
import { apply as applyLocale, inject as localeInject } from '@coomi/coomi-client-locale/client'
import {

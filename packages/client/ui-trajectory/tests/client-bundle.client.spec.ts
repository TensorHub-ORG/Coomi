 ...
 * not built (`pnpm --filter @coomi/coomi-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@coomi/coomi-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@coomi/coomi-client-runtime/client', await import('@coomi/coomi-client-runtime/client')],
      ['@coomi/coomi-client-ui-primitives', await import('@coomi/coomi-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@coomi/coomi-client-locale/client')

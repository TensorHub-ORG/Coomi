...
import { bindSnapshotSelector } from '@coomi/coomi-client-web-react'
import { resolveSlotLabel } from '@coomi/coomi-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@coomi/coomi-client-runtime/client'
import { SlotRegistry } from '@coomi/coomi-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@coomi/coomi-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@coomi/coomi-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@coomi/coomi-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@coomi/coomi-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@coomi/coomi-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@coomi/coomi-client-locale/client'
import { stubSettingsScope } from '@coomi/coomi-client-test-runtime'
import type { LocaleKeysOf } from '@coomi/coomi-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@coomi/coomi-client-ui-trajectory/client'
import { apply as nodeApply } from '@coomi/coomi-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('coomi.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`coomi.trajectory.duration.${SID}`)).toBeNull()
  })

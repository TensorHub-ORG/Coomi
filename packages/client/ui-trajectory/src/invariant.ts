/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-trajectory`.
 * @module @coomi/coomi-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-trajectory'

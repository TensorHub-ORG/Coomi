...
import { LocaleRuntime } from '@coomi/coomi-client-locale/client'
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@coomi/coomi-client-ui-theme/client'
import { apply, inject, LayoutController } from '@coomi/coomi-client-ui-layout/client'
import { apply as nodeApply } from '@coomi/coomi-client-ui-layout'
import * as invariant from '@coomi/coomi-client-ui-layout/invariant'
...
describe('ui-layout client apply', () => {
  ...
  it('theme presenter applies the initial snapshot, follows theme/change, and unwinds on dispose', async () => {
    ...
    expect(document.body.hasAttribute('data-coomi-dark-theme')).toBe(false)
    ...
    expect(document.body.hasAttribute('data-coomi-dark-theme')).toBe(true)
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@coomi/coomi-client-ui-layout', expect.any(Function))

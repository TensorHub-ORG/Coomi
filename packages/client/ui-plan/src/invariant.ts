/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-plan`.
 * @module @coomi/coomi-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-plan'
 ...
 * audited by coomi-plan-mode, while the control is a slot effect whose

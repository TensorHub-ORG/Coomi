/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-commands`.
 * @module @coomi/coomi-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-commands'

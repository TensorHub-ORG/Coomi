/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-settings`.
 * @module @coomi/coomi-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-settings'

...
import * as primitives from '@coomi/coomi-client-ui-primitives'
import {
...
describe('CoomiLogo', () => {
  it('renders the Coomi mark as an inline image at the requested size', () => {
    const { container } = render(<primitives.CoomiLogo />)

...
import {
  CoomiLogo, IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16,
} from '@coomi/coomi-client-ui-primitives'
import { workspaceTitleOf } from '@coomi/coomi-client-runtime/client'
      ...
      <div className={css.stack}>
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            <CoomiLogo size={34} className={css.fish} />
          </span>

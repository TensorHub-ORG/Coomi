...
} from '@coomi/coomi-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@coomi/coomi-client-ui-attachment'
import type { AttachmentRailItem } from '@coomi/coomi-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@coomi/coomi-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@coomi/coomi-goal/client'
...
import type { Translate } from '@coomi/coomi-client-ui-slots'

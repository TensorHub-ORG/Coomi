 ...
 * atoms' label props (`@coomi/coomi-client-ui-attachment` reads no
...
} from '@coomi/coomi-client-ui-attachment'
import type { ImageAttachmentLimits } from '@coomi/coomi-attachment'

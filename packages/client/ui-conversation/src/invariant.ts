/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-conversation`.
 * @module @coomi/coomi-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-conversation'

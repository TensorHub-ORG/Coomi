...
import type { ClientContext } from '@coomi/coomi-client-runtime/client'
import { makeTranslate } from '@coomi/coomi-client-test-runtime'
import { en as commonEn } from '@coomi/coomi-client-locale/src/locales/en.ts'
...
describe('Hero chrome', () => {
  it('renders the English beta badge through the hero locale seat', () => {
    ...
    expect(view.getByText('What are we working on today?')).toBeTruthy()
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText('今天有什么工作？')).toBeTruthy()
    expect(b.view.getByText('测试版')).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText('今天有什么工作？')).toBeNull()
  })

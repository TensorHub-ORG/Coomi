/**
 * Browser theme registry over the `--coomi-*` token stylesheets. The service
...
import type { BoundActions } from '@coomi/coomi-client-ui-slots'
import type { ClientContext, SettingsScope } from '@coomi/coomi-client-runtime/client'
// Type-only: the ctx.settingsScope Context merge. Cross-plugin collaboration
// goes through the service, never a value import (client bundle purity gate).
import type {} from '@coomi/coomi-client-ui-settings/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@coomi/coomi-client-locale/client'
...
declare module '@coomi/coomi-client-ui-slots' {
...
/** Theme token dictionary: --coomi-alias-* overrides keyed by variable name. */
...
export interface ThemeDefinition {
   ...
   * `body[data-coomi-dark-theme]` from this field — never from the id.
   */
...
const BUILTIN_INSPECT_TOKENS: readonly ThemeTokenInspection[] = Object.freeze([
  { name: '--coomi-alias-bg-base', description: 'Application base background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-bg-base' },
  { name: '--coomi-alias-bg-layer-1', description: 'Primary raised surface background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-bg-layer-1' },
  { name: '--coomi-alias-bg-layer-2', description: 'Secondary nested surface background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-bg-layer-2' },
  { name: '--coomi-alias-bg-overlay', description: 'Overlay and popover background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-bg-overlay' },
  { name: '--coomi-alias-border-l1', description: 'Primary subtle border.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-border-l1' },
  { name: '--coomi-alias-border-l2', description: 'Secondary stronger border.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-border-l2' },
  { name: '--coomi-alias-brand-primary', description: 'Primary brand accent.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-brand-primary' },
  { name: '--coomi-alias-label-primary', description: 'Primary text color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-label-primary' },
  { name: '--coomi-alias-label-secondary', description: 'Secondary text color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-label-secondary' },
  { name: '--coomi-alias-state-error-primary', description: 'Primary error state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-state-error-primary' },
  { name: '--coomi-alias-state-success-primary', description: 'Primary success state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-state-success-primary' },
  { name: '--coomi-alias-state-warn-primary', description: 'Primary warning state color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-alias-state-warn-primary' },
  { name: '--coomi-specific-sidebar-fill', description: 'Sidebar column and title-row background.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--coomi-specific-sidebar-fill' },
])

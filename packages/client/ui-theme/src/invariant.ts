/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-theme`.
 * @module @coomi/coomi-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-theme'

...
import type { WebBootGraph, ClientModuleRegistry } from '@coomi/coomi-client-modules'
import type { WebRoute, WebServer } from '@coomi/coomi-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'coomi-hmr-')) })

/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-slots`.
 * @module @coomi/coomi-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-slots'

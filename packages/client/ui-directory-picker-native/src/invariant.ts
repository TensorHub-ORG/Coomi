/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-directory-picker-native`.
 * @module @coomi/coomi-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-directory-picker-native'

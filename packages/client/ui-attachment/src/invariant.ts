/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-attachment`.
 * @module @coomi/coomi-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-attachment'

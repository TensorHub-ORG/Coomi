/**
 * Package-owned invariant companion for `@coomi/coomi-client-runtime`.
 * @module @coomi/coomi-client-runtime/invariant
 */
...
import type { SlotMap } from '@coomi/coomi-client-ui-slots'
import type { InvariantInstaller } from '@coomi/coomi-invariants'

const PACKAGE_NAME = '@coomi/coomi-client-runtime'

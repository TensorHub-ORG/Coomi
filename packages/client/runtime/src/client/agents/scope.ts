 ...
 * Agent's identity. The mechanism mirrors the host `coomi-scope` architecture
...
import type { SessionId } from '@coomi/coomi-api-remotes/client'
import type { TypertClientRemote, TypertRemoteScopeApi } from '@coomi/coomi-typert-protocol'
...
const kScope = Symbol('coomi.client.scope')

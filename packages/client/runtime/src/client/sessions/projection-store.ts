...
// (`/types`, zero imports), never the package root: the root's coomi-agent →
// coomi-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@coomi/coomi-session-projection/types'

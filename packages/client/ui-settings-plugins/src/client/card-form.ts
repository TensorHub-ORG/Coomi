...
import type { SettingsScope, SettingsScopeSnapshot } from '@coomi/coomi-client-runtime/client'
import { createSnapshotStore, type SnapshotStore } from '@coomi/coomi-client-runtime/client'

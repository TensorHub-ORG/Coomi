...
import { TestRemote, usePinnedBrowserLanguages } from '@coomi/coomi-client-test-runtime'
import { SettingsScopeBinder } from '@coomi/coomi-client-ui-settings/client'
import { apply, inject } from '@coomi/coomi-client-ui-settings-plugins/client'
import type {
  ConfigurablePluginsTabInjected, PluginsSettingsSectionInjected,
} from '@coomi/coomi-client-ui-settings-plugins/client'

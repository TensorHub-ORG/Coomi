 ...
 * `window.__COOMI_BOOT__` into the two-view BootManifest (wire boundary)
...
import * as ModulesClient from '@coomi/coomi-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type coomiWindow,
} from '@coomi/coomi-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@coomi/coomi-client-modules'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    this.manifest = parseBootManifest((globalThis as coomiWindow).__COOMI_BOOT__)
    ...
    ;(globalThis as coomiWindow).__COOMI_MODULES__ = this.modules

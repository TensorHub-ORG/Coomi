 ...
 * @module @coomi/coomi-client-web/src/loader-status
 */
import type { FiberState } from '@coomi/cordis'
 ...
 * while retaining its type (same rationale as coomi-tool-cordis's mirror).
 */

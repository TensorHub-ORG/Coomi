/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-goal`.
 * @module @coomi/coomi-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-goal'

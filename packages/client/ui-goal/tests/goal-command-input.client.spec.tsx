...
import { ConversationNodeAssembler } from '@coomi/coomi-client-runtime/client'
...
import type { SessionEvent } from '@coomi/coomi-session/types'
import { commandDefinition } from '@coomi/coomi-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@coomi/coomi-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'

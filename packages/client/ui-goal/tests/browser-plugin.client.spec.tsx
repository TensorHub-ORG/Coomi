...
import { SlotRegistry, type SessionId } from '@coomi/coomi-client-runtime/client'
import { ConversationEventRegistry } from '@coomi/coomi-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@coomi/coomi-goal/client'

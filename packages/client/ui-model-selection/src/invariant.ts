/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-model-selection`.
 * @module @coomi/coomi-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-model-selection'

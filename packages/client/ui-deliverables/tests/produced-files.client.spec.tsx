...
import type { ChatFileMentions, TurnTailOwnerProps } from '@coomi/coomi-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@coomi/coomi-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@coomi/coomi-client-ui-deliverables'])

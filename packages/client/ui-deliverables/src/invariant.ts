/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-deliverables`.
 * @module @coomi/coomi-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-deliverables'

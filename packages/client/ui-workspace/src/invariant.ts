/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-workspace`.
 * @module @coomi/coomi-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-workspace'

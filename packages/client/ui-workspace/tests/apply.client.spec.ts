...
import { apply, inject } from '@coomi/coomi-client-ui-workspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from '@coomi/coomi-client-ui-workspace/client'

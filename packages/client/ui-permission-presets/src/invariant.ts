/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-permission-presets`.
 * @module @coomi/coomi-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-permission-presets'

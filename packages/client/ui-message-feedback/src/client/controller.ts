 ...
 * @module @coomi/coomi-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@coomi/coomi-typert-protocol'
import type { HostObservable } from '@coomi/coomi-client-ui-slots'
import type { MessageId, SessionId } from '@coomi/coomi-client-connection/client'
import type {
...
} from '@coomi/coomi-message-feedback/types'

/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-message-feedback`.
 * @module @coomi/coomi-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-message-feedback'

/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-agent-preset`.
 * @module @coomi/coomi-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-agent-preset'

/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-directory-picker-browse`.
 * @module @coomi/coomi-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-directory-picker-browse'

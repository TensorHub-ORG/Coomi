/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-tool`.
 * @module @coomi/coomi-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-tool'

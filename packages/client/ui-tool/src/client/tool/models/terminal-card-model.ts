...
import type { TerminalBlockLabels, TerminalBlockProps } from '@coomi/coomi-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in coomi-client-runtime), leaving a terminal

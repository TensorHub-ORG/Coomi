...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@coomi/coomi-client-ui-slots'
import type { ToolCallBlock } from '@coomi/coomi-client-runtime/client'

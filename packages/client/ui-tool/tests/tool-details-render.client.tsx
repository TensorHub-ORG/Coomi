...
import type { SessionProviderComponent, TranslateNS } from '@coomi/coomi-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@coomi/coomi-client-ui-conversation/src/client/contract/slots.ts'

...
import type { ToolResultView } from '@coomi/coomi-api-remotes/client'
import { bindSnapshotSelector } from '@coomi/coomi-client-web-react'
import type { SelectionTarget } from '@coomi/coomi-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@coomi/coomi-client-ui-tool/client'
import { IconGlobeOutline14 } from '@coomi/coomi-client-ui-primitives'
...
import { DetailsPanel } from '@coomi/coomi-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
import { WebRow, webToolview } from '../src/client/tool/toolviews/web-row.tsx'
import { renderToolDetails, SessionProviderStub, toolChatSnapshot } from './tool-details-render.client.tsx'
import { makeTranslate } from '@coomi/coomi-client-test-runtime'
import { zh as commonZh } from '@coomi/coomi-client-locale/src/locales/zh.ts'
import { zh } from '@coomi/coomi-client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@coomi/cordis').Context

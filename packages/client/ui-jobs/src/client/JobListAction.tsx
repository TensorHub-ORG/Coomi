...
import type { JobView } from '@coomi/coomi-client-runtime/client'
import { IconChevronDownOutline14, StateDot, type StateDotState } from '@coomi/coomi-client-ui-primitives'

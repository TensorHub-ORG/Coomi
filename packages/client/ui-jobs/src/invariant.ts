/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-jobs`.
 * @module @coomi/coomi-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-jobs'

...
import type {} from '@coomi/coomi-attachment'
// Activates the webServer Context merge used below.
import type { WebRoute, WebUpgradeRoute } from '@coomi/coomi-host-webserver'
import { toFetchHandler } from '@coomi/coomi-host-apiproxy'

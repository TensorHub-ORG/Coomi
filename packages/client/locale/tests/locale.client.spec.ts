...
import type { LocaleSettings, LocaleSnapshot } from '@coomi/coomi-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (coomi-client-test-runtime): they need the shapes

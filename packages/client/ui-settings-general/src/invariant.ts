/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-settings-general`.
 * @module @coomi/coomi-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-settings-general'

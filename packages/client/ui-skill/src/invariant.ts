/**
 * Package-owned invariant companion for `@coomi/coomi-client-ui-skill`.
 * @module @coomi/coomi-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-client-ui-skill'

 ...
 * determinism
 * lives host-side — the pre-step boundary (`coomi-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@coomi/coomi-api-remotes/client'
import type { ClientContext, ISessions } from '@coomi/coomi-client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@coomi/coomi-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (coomi-tool-skill) recognizes the leading /name and

...
import type { Agent, AgentOptions, AgentSetup } from '@coomi/coomi-agent'
...
import type {} from '@coomi/coomi-typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a coomi-session-persistence backend)')
  }

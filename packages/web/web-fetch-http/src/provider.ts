 ...
 * `@coomi/coomi-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @coomi/coomi-web-fetch-http/provider
 */

import { WebError } from '@coomi/coomi-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@coomi/coomi-web'

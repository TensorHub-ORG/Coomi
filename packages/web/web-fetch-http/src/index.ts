/**
 * `@coomi/coomi-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @coomi/coomi-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'coomi-desktop/0.0.1 (+https://github.com/coomi)'

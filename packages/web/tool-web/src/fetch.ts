...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@coomi/coomi-tools'
import type { WebFetchBody, WebFetchResult } from '@coomi/coomi-web'
 ...
 * `@coomi/coomi-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@coomi/coomi-tool-call-timeout-policy` to enforce.

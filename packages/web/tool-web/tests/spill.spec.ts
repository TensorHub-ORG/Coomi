 ...
 * (`coomi-spill-local` backend + `coomi-spill-policy`), exercised through
...
import LocalSpillStore from '@coomi/coomi-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'coomi-spill-web-'))

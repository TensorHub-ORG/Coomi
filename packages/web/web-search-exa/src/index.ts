/**
 * `@coomi/coomi-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@coomi/coomi-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@coomi/coomi-web`.
 *
 * @module @coomi/coomi-web-search-exa
 */
...
import type {} from '@coomi/coomi-web'
import {
  ExaSearchProvider,

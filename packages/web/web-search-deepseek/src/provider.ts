 ...
 * @module @coomi/coomi-web-search-deepseek/provider
 */

import { WebError } from '@coomi/coomi-web'
import type {
  WebSearchProvider,
  WebSearchRequest,
  WebSearchResult,
  WebSearchSource,
} from '@coomi/coomi-web'
 ...
 * (`https://api.deepseek.com`) `@coomi/coomi-llm-deepseek` uses, so this
...
const USER_AGENT = 'coomi-desktop/0.0.1'

/**
 * Package-owned invariant companion for `@coomi/coomi-web-search-deepseek`.
 * @module @coomi/coomi-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-web-search-deepseek'

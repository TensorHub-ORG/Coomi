/**
 * Package-owned invariant companion for `@coomi/coomi-typert-registry`.
 * @module @coomi/coomi-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-typert-registry'

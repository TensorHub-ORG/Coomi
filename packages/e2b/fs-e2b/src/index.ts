...
import type { EntryInfo, Sandbox } from '@coomi/coomi-e2b'

const VERSION_METADATA_KEY = 'coomi-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.coomi-${randomUUID()}.tmp`)

/** Package-owned invariant companion for the directory-picker seam. @module @coomi/coomi-host-directory-picker/invariant */

import type { Context } from '@coomi/cordis'
import type { InvariantInstaller } from '@coomi/coomi-invariants'

const PACKAGE_NAME = '@coomi/coomi-host-directory-picker'

/**
 * Package-owned invariant companion for `@coomi/coomi-host-frontend-static`.
 * @module @coomi/coomi-host-frontend-static/invariant
 */

import type { Context } from '@coomi/cordis'
import type { InvariantInstaller } from '@coomi/coomi-invariants'

const PACKAGE_NAME = '@coomi/coomi-host-frontend-static'

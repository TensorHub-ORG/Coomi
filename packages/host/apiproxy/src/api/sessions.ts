...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@coomi/coomi-attachment'
import type { ContentBlock } from '@coomi/coomi-llm/types'
import type { SessionEvent, SessionId } from '@coomi/coomi-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via coomi-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@coomi/coomi-session-projection/types'

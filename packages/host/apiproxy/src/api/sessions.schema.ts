...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@coomi/coomi-attachment'
 ...
 * the coomi-tools vocabulary into this schema and drift with it.
 */

...
import type { AskUserQuestionItem } from '@coomi/coomi-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@coomi/coomi-user-approval/types'
import type { Message } from '@coomi/coomi-llm/types'
import type { MessageId } from '@coomi/coomi-llm/brand'
import type { CallId } from '@coomi/coomi-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@coomi/coomi-session/types'
import type { ToolCallView, ToolResultView } from '@coomi/coomi-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// coomi-tools remains its owner.
export type { ToolCallView, ToolResultView } from '@coomi/coomi-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@coomi/coomi-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),

...
import type { Agent, AgentFactory } from '@coomi/coomi-agent'
...
import type { DirectoryPickerCapability } from '@coomi/coomi-host-directory-picker'
import WorkspaceRegistry from '@coomi/coomi-workspace'
import type { HostFrame, WorkspaceId } from '@coomi/coomi-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@coomi/coomi-host-apiproxy/api/rpc'
import { RpcId } from '@coomi/coomi-host-apiproxy/api/rpc'
import { createApiProxy } from '@coomi/coomi-host-apiproxy'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'coomi-apiproxy-workspace-'))),

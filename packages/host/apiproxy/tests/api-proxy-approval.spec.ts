...
import type { ApprovalRequestId } from '@coomi/coomi-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@coomi/coomi-host-apiproxy/api'
import type { RpcId } from '@coomi/coomi-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@coomi/coomi-host-apiproxy/api/rpc'

...
import AgentRegistry, { type AgentFactory } from '@coomi/coomi-agent'
...
import { GoalId } from '@coomi/coomi-goal'
...
async function harness(
  ...
  const cwd = realpathSync(mkdtempSync(join(tmpdir(), 'coomi-apiproxy-preset-')))

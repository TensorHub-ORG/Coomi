 ...
 * @module @coomi/coomi-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@coomi/coomi-host-directory-picker-native',
  browse: '@coomi/coomi-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@coomi/coomi-client-ui-directory-picker-native',
  browse: '@coomi/coomi-client-ui-directory-picker-browse',
}

...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@coomi/coomi-tools'
import { Session, SessionId, type UserMessage } from '@coomi/coomi-session'
import AgentRegistry, { agentEvents, type Agent } from '@coomi/coomi-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@coomi/coomi-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `coomi-plan-mode` beside real `SystemPrompt` and

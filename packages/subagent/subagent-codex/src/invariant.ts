/**
 * Package-owned invariant companion for `@coomi/coomi-subagent-codex`.
 * @module @coomi/coomi-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-subagent-codex'

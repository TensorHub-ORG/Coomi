/**
 * Package-owned invariant companion for `@coomi/coomi-subagent-coomi-sdk`.
 * @module @coomi/coomi-subagent-coomi-sdk/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-subagent-coomi-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-coomi-sdk-invariant'

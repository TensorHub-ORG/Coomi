...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@coomi/coomi-sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@coomi/coomi-user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'coomi-continuation-inherit-'))
  roots.push(root)

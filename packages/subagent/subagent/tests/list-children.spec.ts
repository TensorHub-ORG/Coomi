...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@coomi/coomi-session'
import type { SessionEvent, SessionHeader } from '@coomi/coomi-session'
...
import type { ProjectionDefinition } from '@coomi/coomi-session-projection'
import SessionProjectionCache from '@coomi/coomi-session-projection-cache'
import Storage from '@coomi/coomi-storage'
import { DomainFacility } from '@coomi/coomi-storage-domain'
import { MemoryMediaPool, MemoryStorageBackend } from '../../../storage/storage-domain/tests/helpers/memory-backend.ts'
import SubagentRuntime, {
  SUBAGENT_DESCRIPTOR_VERSION,
  SubagentError,
} from '@coomi/coomi-subagent'
import * as SubagentSpawn from '@coomi/coomi-subagent-spawn-in-process'
import * as SubagentFork from '@coomi/coomi-subagent-fork-in-process'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'coomi-subagent-list-'))
  roots.push(root)
...
declare module '@coomi/coomi-session-projection/types' {

 ...
 *
 * @module @coomi/coomi-subagent/types
 */

import type { Agent, AgentOptions } from '@coomi/coomi-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@coomi/coomi-tools'

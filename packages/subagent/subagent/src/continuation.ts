...
import { boundContextSummary, createUserMessage, errorChain } from '@coomi/coomi-llm'
import type { ContentBlock, MessageId, MessageSource } from '@coomi/coomi-llm'
...
import type { ToolRestriction } from '@coomi/coomi-tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a coomi-session-persistence backend)',

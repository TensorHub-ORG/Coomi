...
import type { SessionProjectionRegistry } from '@coomi/coomi-session-projection'
import type { SessionProjectionCache } from '@coomi/coomi-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @coomi/coomi-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @coomi/coomi-session)',

 ...
 * (`@coomi/coomi-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@coomi/coomi-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@coomi/coomi-tools'
import type { ContentBlock, MessageId } from '@coomi/coomi-llm'

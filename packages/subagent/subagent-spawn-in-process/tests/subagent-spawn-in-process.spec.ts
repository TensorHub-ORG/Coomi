...
import { Context, symbols, type EffectMeta } from '@coomi/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@coomi/coomi-subagent'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@coomi/coomi-subagent-in-process-driver'
...
describe('coomi-subagent-spawn-in-process', () => {

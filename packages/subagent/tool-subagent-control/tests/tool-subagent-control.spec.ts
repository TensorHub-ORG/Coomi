...
async function setupWith(adapter: MockAdapter | GatedAdapter) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'coomi-tool-subagent-control-'))
  roots.push(root)
...
describe('coomi-tool-subagent-control', () => {
...
describe('coomi-tool-subagent-control interrupt_agent', () => {

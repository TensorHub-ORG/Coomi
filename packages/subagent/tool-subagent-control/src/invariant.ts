/**
 * Package-owned invariant companion for `@coomi/coomi-tool-subagent-control`.
 * @module @coomi/coomi-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-tool-subagent-control'

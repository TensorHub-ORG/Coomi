/**
 * Package-owned invariant companion for `@coomi/coomi-tool-subagent-report`.
 * @module @coomi/coomi-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-tool-subagent-report'

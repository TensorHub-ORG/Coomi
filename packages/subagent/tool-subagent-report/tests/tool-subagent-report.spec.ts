...
import { assembleContextFor } from '@coomi/coomi-agent'
...
import type { GenerateOptions, StreamChunk } from '@coomi/coomi-llm'
...
import * as control from '@coomi/coomi-tool-subagent-control'
...
async function setup(options: { load?: boolean; config?: tool.Config } = {}) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'coomi-tool-subagent-report-'))
...
describe('coomi-tool-subagent-report', () => {
...
describe('coomi-tool-subagent-report result independence', () => {

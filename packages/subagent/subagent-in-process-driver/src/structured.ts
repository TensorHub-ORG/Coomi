 ...
 * @module @coomi/coomi-subagent-in-process-driver/structured
 */

import type { Context } from '@coomi/cordis'
import type { ToolSchema } from '@coomi/coomi-llm'
import type { ToolExecution, ToolRunContext } from '@coomi/coomi-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@coomi/coomi-tools'
 ...
 *   `assertObjectJsonSchema` in coomi-tools).

 ...
 * one result.
 *
 * @module @coomi/coomi-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@coomi/cordis'
import { foldConsumedWork } from '@coomi/coomi-agent'
...
import { createUserMessage, type ContentBlock } from '@coomi/coomi-llm'
import {

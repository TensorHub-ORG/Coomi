/**
 * Package-owned invariant companion for `@coomi/coomi-session-persistence-sqlite`.
 * @module @coomi/coomi-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-persistence-sqlite'

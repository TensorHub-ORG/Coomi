/**
 * OpenTelemetry Service Provider for the Coomi telemetry capability.
 *
 ...
 *
 * @module @coomi/coomi-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@coomi/schemastery'
import type { Context } from '@coomi/cordis'
import type {} from '@coomi/coomi-command-feedback'
import {
...
} from '@coomi/coomi-session-telemetry'
import { APP_IDENTITY } from '@coomi/coomi-llm'
...
// version (same pattern as coomi-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@coomi/coomi-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@coomi/coomi-session-telemetry-otel/ops', version)

/**
 * Package-owned invariant companion for `@coomi/coomi-session-telemetry-otel`.
 * @module @coomi/coomi-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-telemetry-otel'

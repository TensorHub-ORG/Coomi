/**
 * Package-owned invariant companion for `@coomi/coomi-session-telemetry`.
 * @module @coomi/coomi-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-telemetry'

 ...
 * (`deriveStats` in coomi-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @coomi/coomi-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@coomi/coomi-llm/message'

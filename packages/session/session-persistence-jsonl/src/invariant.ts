/**
 * Package-owned invariant companion for `@coomi/coomi-session-persistence-jsonl`.
 * @module @coomi/coomi-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-persistence-jsonl'

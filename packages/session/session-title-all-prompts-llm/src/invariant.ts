/**
 * Package-owned invariant companion for `@coomi/coomi-session-title-all-prompts-llm`.
 * @module @coomi/coomi-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-title-all-prompts-llm'

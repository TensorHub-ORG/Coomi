 ...
 * @module @coomi/coomi-session-title-llm
 */

import type { Context } from '@coomi/cordis'
import z from '@coomi/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@coomi/coomi-llm'
import type { FinishReason, GenerateOptions, Message } from '@coomi/coomi-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@coomi/coomi-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@coomi/coomi-session-title'
import type {
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'coomi-session-title-llm' },
  })]

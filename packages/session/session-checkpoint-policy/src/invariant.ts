/**
 * Package-owned invariant companion for `@coomi/coomi-session-checkpoint-policy`.
 * @module @coomi/coomi-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-checkpoint-policy'

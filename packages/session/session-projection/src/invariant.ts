/**
 * Package-owned invariant companion for `@coomi/coomi-session-projection`.
 * @module @coomi/coomi-session-projection/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-projection'

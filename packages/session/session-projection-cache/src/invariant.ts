/**
 * Package-owned invariant companion for `@coomi/coomi-session-projection-cache`.
 * @module @coomi/coomi-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-projection-cache'

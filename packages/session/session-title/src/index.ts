 ...
 * @module @coomi/coomi-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@coomi/cordis'
import z from '@coomi/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@coomi/coomi-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@coomi/coomi-llm'
import type { GenerateOptions } from '@coomi/coomi-llm'
import type {
  Session,
  SessionEvent,

 ...
 * @module @coomi/coomi-session-persistence
 */

import { Context, Service } from '@coomi/cordis'
import { SessionPreparation } from '@coomi/coomi-session'
import type { SessionEvent, SessionId, SessionHeader } from '@coomi/coomi-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@coomi/coomi-session'

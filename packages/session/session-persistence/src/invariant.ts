/**
 * Package-owned invariant companion for `@coomi/coomi-session-persistence`.
 * @module @coomi/coomi-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-persistence'

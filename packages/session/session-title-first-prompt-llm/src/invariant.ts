/**
 * Package-owned invariant companion for `@coomi/coomi-session-title-first-prompt-llm`.
 * @module @coomi/coomi-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-title-first-prompt-llm'

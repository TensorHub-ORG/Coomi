/**
 * Package-owned invariant companion for `@coomi/coomi-session-reference`.
 * @module @coomi/coomi-session-reference/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-session-reference'

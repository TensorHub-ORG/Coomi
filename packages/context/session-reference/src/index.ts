 ...
 *
 * @module @coomi/coomi-session-reference
 */
...
import type { ContentBlock, UserMessage } from '@coomi/coomi-llm'
import type { SessionId } from '@coomi/coomi-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@coomi/coomi-session-query'
import {

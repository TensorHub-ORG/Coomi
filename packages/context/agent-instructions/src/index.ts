 ...
 * mount it as a no-op.
 *
 * @module @coomi/coomi-agent-instructions
 */
...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@coomi/coomi-tools'

 ...
 *
 * @module @coomi/coomi-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$COOMI_HOME`.
 * Discovery (`$COOMI_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.coomi/AGENTS.md' || displayPath === '$COOMI_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY

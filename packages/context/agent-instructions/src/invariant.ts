/**
 * Package-owned invariant companion for `@coomi/coomi-agent-instructions`.
 * @module @coomi/coomi-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-agent-instructions'

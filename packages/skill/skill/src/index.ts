 ...
 * Concrete
 * providers such as `@coomi/coomi-skill-filesystem` decide where skills come
 ...
 *
 * @module @coomi/coomi-skill
 */

import { Context, Service } from '@coomi/cordis'
import { assertNever } from '@coomi/coomi-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@coomi/coomi-scope'
import type { ScopeKey, ScopeLayer } from '@coomi/coomi-scope'
...
export type SkillSource = 'project-coomi' | 'project-agents' | 'runtime' | 'user-coomi' | 'user-agents' | 'custom' | 'bundled' | (string & {})

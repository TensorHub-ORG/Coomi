 ...
 * @module @coomi/coomi-tool-terminal
 */
...
import { TerminalSessionId } from '@coomi/coomi-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@coomi/coomi-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @coomi/coomi-jobs and @coomi/coomi-tool-jobs')

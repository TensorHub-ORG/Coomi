 ...
 * @module @coomi/coomi-terminal-bash
 */
...
import { TerminalBackendCleanupError } from '@coomi/coomi-terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec } from '@coomi/coomi-terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@coomi/coomi-subprocess'
import type { SandboxExecutionPolicy } from '@coomi/coomi-sandbox'
import { effectiveSandboxMode } from '@coomi/coomi-sandbox-policy'
...
function childEnvironment(spec: TerminalBackendSpawnSpec): Record<string, string> {
  ...
  return {
    ...
    COOMI_SHELL: '1',
    COOMI_SESSION_ID: spec.owner.id,
    COOMI_PTY_SESSION_ID: spec.sessionId,
  }
}

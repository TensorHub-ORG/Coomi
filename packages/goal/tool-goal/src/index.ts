 ...
 * @module @coomi/coomi-tool-goal
 */

import type { Context } from '@coomi/cordis'
import z from '@coomi/schemastery'
import { GoalId } from '@coomi/coomi-goal'
import type { GoalRef, GoalView } from '@coomi/coomi-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@coomi/coomi-llm'
import { defineTool } from '@coomi/coomi-tools'
import type { GenericCallView } from '@coomi/coomi-tools'

...
import { createUserMessage, HarnessError } from '@coomi/coomi-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@coomi/coomi-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@coomi/coomi-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@coomi/coomi-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@coomi/coomi-session').SessionEvent[]): StubAgent {

...
import * as GoalSessionInvariant from '@coomi/coomi-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@coomi/coomi-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@coomi/coomi-invariants'
import SessionStore, { SessionId, type Session } from '@coomi/coomi-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@coomi/coomi-goal-round-driver',
    }))
  })

/** Package-owned goal-round prompt invariants. @module @coomi/coomi-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@coomi/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@coomi/coomi-goal'
import type { InvariantFailure, InvariantInstaller } from '@coomi/coomi-invariants'
import type { Session, SessionEvent } from '@coomi/coomi-session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@coomi/coomi-goal-round-driver'

 ...
 * @module @coomi/coomi-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('coomi-code-runtime-worker-thread: worker entry loaded outside a worker thread')

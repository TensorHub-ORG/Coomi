/** JSON string-prefix accounting for the outer-output ledger. @module @coomi/coomi-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@coomi/coomi-code-runtime'

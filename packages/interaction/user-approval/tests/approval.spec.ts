...
import { carrierKeyOf, createScope } from '@coomi/coomi-scope'
...
import ApprovalService, { ApprovalOutcome, ApprovalRequest, effectiveApprovalPolicy, setApprovalPolicy } from '@coomi/coomi-user-approval'

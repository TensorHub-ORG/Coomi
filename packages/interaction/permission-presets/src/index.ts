 ...
 *
 * @module coomi-permission-presets
 */

import { Context, Service } from '@coomi/cordis'
import z from '@coomi/schemastery'
import { z as zod } from 'zod'
import type { Session, SessionEvent } from '@coomi/coomi-session'
import type { SandboxMode } from '@coomi/coomi-sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@coomi/coomi-sandbox-policy'
...
import type {} from '@coomi/coomi-shell'
import type { ApprovalPolicy } from '@coomi/coomi-user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@coomi/coomi-user-approval'
import { installSettingsSection, settingsNamespace } from '@coomi/coomi-settings'
...
declare module '@coomi/coomi-session/types' {

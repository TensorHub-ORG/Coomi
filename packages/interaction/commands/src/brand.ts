/**
 * coomi-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@coomi/coomi-brand`; this module
 ...
 * loading the host plugin's Context merges — the `coomi-llm/brand` shape.
 *
 * @module @coomi/coomi-commands/brand
 */

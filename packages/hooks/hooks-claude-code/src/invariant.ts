/**
 * Package-owned invariant companion for `@coomi/coomi-hooks-claude-code`.
 * @module @coomi/coomi-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-hooks-claude-code'

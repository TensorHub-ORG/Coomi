 ...
 * mapping; shared execution and parsing live in `coomi-hook-protocol`.
 ...
 * @module @coomi/coomi-hooks-claude-code
 */
...
import type { UserMessage } from '@coomi/coomi-session'
import type {} from '@coomi/coomi-session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@coomi/coomi-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@coomi/coomi-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@coomi/coomi-subagent'

 ...
 * @module @coomi/coomi-agent-presets/mount
 */
...
import type { EntryTree } from '@coomi/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@coomi/coomi-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@coomi/coomi-*` row would fail to import. The
 ...
 * invariant companion's service listener, and `coomi-invariants` is a

 ...
 * @module @coomi/coomi-agent-presets/discovery
 */
...
import { expandHomePath } from '@coomi/coomi-home-paths'
 ...
 *
 * This package owns the writable root the way `coomi-skill-filesystem` owns
 * `<coomiHome>/skills`. An app must assemble the SHIPPED root, whose path only

/**
 * Package-owned invariant companion for `@coomi/coomi-agent-presets`.
 * @module @coomi/coomi-agent-presets/invariant
 */
...
// joins, and the `agent` field `coomi-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@coomi/coomi-agent-presets'

const PACKAGE_NAME = '@coomi/coomi-agent-presets'

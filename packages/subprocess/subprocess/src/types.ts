 ...
 * @module coomi-subprocess/types
 */

import type { Readable, Writable } from 'node:stream'

/** Namespace prefix reserved for Coomi-managed child environment facts. */
export const COOMI_ENV_PREFIX = 'COOMI_' as const

/** One environment key inside the managed {@link COOMI_ENV_PREFIX} namespace. */
export type coomiEnvironmentKey = `${typeof COOMI_ENV_PREFIX}${string}`

/** Trusted Coomi variables for one child-process execution. */
export type coomiEnvironment = Readonly<Record<coomiEnvironmentKey, string>>
 ...
 * to `TerminalSignal` in `@coomi/coomi-terminal` without a cross-seam dependency;

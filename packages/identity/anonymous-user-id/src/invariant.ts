/**
 * Package-owned invariant companion for `@coomi/coomi-anonymous-user-id`.
 * @module @coomi/coomi-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-anonymous-user-id'

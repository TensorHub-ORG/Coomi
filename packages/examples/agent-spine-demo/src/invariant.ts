/**
 * Package-owned invariant companion for `@coomi/coomi-agent-spine-demo`.
 * @module @coomi/coomi-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-agent-spine-demo'

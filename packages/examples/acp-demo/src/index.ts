 ...
 * ({@link @coomi/coomi-agent-spine-demo}), JSONL session persistence, and
 * the {@link @coomi/coomi-acp} bridge. The app owns those plugins through one
...
} from '@coomi/coomi-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@coomi/coomi-session-checkpoint-policy'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning coomi-system-prompt schema does the same), while

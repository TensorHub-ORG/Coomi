/**
 * Package-owned invariant companion for `@coomi/coomi-sdk-jsonrpc-demo`.
 * @module @coomi/coomi-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-sdk-jsonrpc-demo'

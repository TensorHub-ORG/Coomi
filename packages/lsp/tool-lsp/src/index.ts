 ...
 * `coomi-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @coomi/coomi-tool-lsp
 */
...
import { LspError } from '@coomi/coomi-lsp'
import type {} from '@coomi/coomi-lsp'

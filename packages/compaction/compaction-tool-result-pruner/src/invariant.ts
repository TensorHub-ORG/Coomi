/**
 * Package-owned invariant companion for `@coomi/coomi-compaction-tool-result-pruner`.
 * @module @coomi/coomi-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-compaction-tool-result-pruner'

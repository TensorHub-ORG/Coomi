 ...
 *
 * @module @coomi/coomi-compaction-basic/summarizer
 */

import type { Context } from '@coomi/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@coomi/coomi-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'coomi-compaction-basic' },
    }),
  ]

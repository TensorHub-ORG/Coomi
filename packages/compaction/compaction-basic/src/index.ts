 ...
 *
 * @module @coomi/coomi-compaction-basic
 */

import { Context } from '@coomi/cordis'
import z from '@coomi/schemastery'
import { CompactionEngine, ManualCompactionError } from '@coomi/coomi-compaction'
import type { CompactionResult, CompactionTrigger } from '@coomi/coomi-compaction'
import type { TokenMeter } from '@coomi/coomi-token-meter'
import type { Session } from '@coomi/coomi-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@coomi/coomi-llm'
...
import type {} from '@coomi/coomi-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,

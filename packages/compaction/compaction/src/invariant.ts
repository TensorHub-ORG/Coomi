/** Package-owned compaction log-stream invariants. @module @coomi/coomi-compaction/invariant */

import type { Context } from '@coomi/cordis'
import { isReplacementSurfaceEvent } from '@coomi/coomi-session'
...
const PACKAGE_NAME = '@coomi/coomi-compaction'

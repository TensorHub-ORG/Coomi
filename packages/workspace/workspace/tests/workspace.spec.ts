...
import type { StorageBackend } from '@coomi/coomi-storage'
import { DomainFacility } from '@coomi/coomi-storage-domain'
import type { DomainChanged } from '@coomi/coomi-storage-domain'
...
async function makeDir(name: string): Promise<string> {
  base ??= await realpath(await mkdtemp(join(tmpdir(), 'coomi-workspace-')))

/**
 * Package-owned invariant companion for `@coomi/coomi-workspace`.
 * @module @coomi/coomi-workspace/invariant
 */
...
import { WorkspaceId } from '@coomi/coomi-workspace'

const PACKAGE_NAME = '@coomi/coomi-workspace'

 ...
 *
 * @module @coomi/coomi-session-query
 */

import { Context, Service } from '@coomi/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@coomi/coomi-session'
import { foldSessionTitle } from '@coomi/coomi-session-title'
import type { SessionTitleSnapshot } from '@coomi/coomi-session-title'
import type {

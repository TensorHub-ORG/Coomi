/**
 * Package-owned invariant companion for `@coomi/coomi-tool-str-replace-editor`.
 * @module @coomi/coomi-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-tool-str-replace-editor'

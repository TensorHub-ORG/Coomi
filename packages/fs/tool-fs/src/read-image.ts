 ...
 * @module @coomi/coomi-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@coomi/cordis'
import { AttachmentError, AttachmentId } from '@coomi/coomi-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@coomi/coomi-attachment'
...
import type { GenericCallView, ToolExecution } from '@coomi/coomi-tools'
import type {} from '@coomi/coomi-fs'

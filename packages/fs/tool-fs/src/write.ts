 ...
 * @module @coomi/coomi-tool-fs/src/write
 */

import type { Context } from '@coomi/cordis'
import { defineTool } from '@coomi/coomi-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@coomi/coomi-tools'
import type { FsWriteOutcome } from '@coomi/coomi-fs'

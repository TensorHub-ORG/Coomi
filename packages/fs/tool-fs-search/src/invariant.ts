/**
 * Package-owned invariant companion for `@coomi/coomi-tool-fs-search`.
 * @module @coomi/coomi-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-tool-fs-search'

 ...
 *
 * @module @coomi/coomi-tool-fs-search/grep
 */

import type { Context } from '@coomi/cordis'
import { defineTool } from '@coomi/coomi-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@coomi/coomi-tools'
import type { RetainedItems } from '@coomi/coomi-output-retention'
import type { SpillRef } from '@coomi/coomi-spill'

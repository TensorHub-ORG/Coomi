/** Shared top-level-call post-policy selection for search result spill. @module coomi-tool-fs-search/direct-call */

import type { Context } from '@coomi/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@coomi/coomi-tools'

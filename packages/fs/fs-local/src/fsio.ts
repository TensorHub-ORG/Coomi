 ...
 * streams large files, and rejects binary data; line windows belong to `coomi-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @coomi/coomi-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@coomi/coomi-fs'

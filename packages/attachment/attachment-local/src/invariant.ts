/** Package-owned invariant companion for `@coomi/coomi-attachment-local`. @module @coomi/coomi-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@coomi/cordis'
import type { InvariantInstaller } from '@coomi/coomi-invariants'

const PACKAGE_NAME = '@coomi/coomi-attachment-local'

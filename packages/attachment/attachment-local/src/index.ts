/** Local durable attachment backend rooted below `COOMI_HOME`. @module @coomi/coomi-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveCoomiHome(config.coomiHome), 'attachments', 'v1'))

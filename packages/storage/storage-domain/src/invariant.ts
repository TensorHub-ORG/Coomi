/**
 * Package-owned invariant companion for `@coomi/coomi-storage-domain`: every
 ...
 * @module @coomi/coomi-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-storage-domain'

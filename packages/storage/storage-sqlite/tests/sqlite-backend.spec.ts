...
import Storage, { storageBackendServiceKey } from '@coomi/coomi-storage'
import type { KvUnitDescriptor } from '@coomi/coomi-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'coomi-storage-sqlite-'))
  dirs.push(dir)

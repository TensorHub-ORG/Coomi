/**
 * Package-owned invariant companion for `@coomi/coomi-storage-sqlite`.
 * @module @coomi/coomi-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@coomi/coomi-storage-sqlite'

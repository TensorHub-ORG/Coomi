...
import type { SaveTextSpill } from '@coomi/coomi-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@coomi/coomi-spill-local'

let root: string

beforeEach(() => {
  root = mkdtempSync(join(tmpdir(), 'coomi-spill-test-'))
})
afterEach(() => {

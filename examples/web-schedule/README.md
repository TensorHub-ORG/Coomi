...
This overlay opts one `coomi web` process into Schedule reminders without changing the shipped default Web composition:

```sh
coomi web --patch examples/web-schedule/cordis.yml
```

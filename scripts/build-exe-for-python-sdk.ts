...
const DEPLOY_ROOT_PACKAGE = 'coomi-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@coomi/coomi-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'coomi-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/coomi_harness_runtime/runtime'

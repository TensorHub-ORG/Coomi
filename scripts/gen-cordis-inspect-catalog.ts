...
import type { CordisCatalogModel, ServiceMethodEntry } from '@coomi/coomi-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@coomi/coomi-tool-cordis/api-catalog', '@coomi/coomi-cordis-client-runner/client/api-catalog')

...
const REPOSITORY_URL = 'https://github.com/coomi/coomi-desktop'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/coomi/coomi-desktop/${repositoryRef}/${path}${suffix}`

...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@coomi/coomi-typert-generator'
import type { CordisCatalogPolicy } from '@coomi/coomi-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@coomi/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  coomiHomePath: 'not a service: boot-provided root accessor function (typeof coomiHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@coomi/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  coomiEnvironment: 'subprocess.md',

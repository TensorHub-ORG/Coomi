...
import { WEB_SEARCH_MAX_RESULTS } from '@coomi/coomi-tool-web'
import {
...
const QUERY = 'Coomi snapshot search'
const PROMPT = `Use web_search to search exactly "${QUERY}". Then reply exactly SEARCH_DONE and stop.`
const SEARCH_CREDENTIAL_REF = credentialRef('COOMI_WEB_SEARCH_E2E_KEY')

...
// in the temp workspace) all run; the model adapter is coomi-llm-replay (keyless)
...
// Record: COOMI_SNAPSHOT=record rewrites session.jsonl, then a keyless
// COOMI_SNAPSHOT=refresh regenerates ui.expected.md.

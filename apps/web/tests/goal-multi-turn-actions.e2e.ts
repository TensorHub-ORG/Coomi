...
import { parseSessionLog } from '@coomi/coomi-llm-replay'
import type { SessionEvent, SessionId } from '@coomi/coomi-session'
import type {} from '@coomi/coomi-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@coomi/coomi-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@coomi/coomi-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@coomi/coomi-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@coomi/coomi-skill-filesystem"}\n',

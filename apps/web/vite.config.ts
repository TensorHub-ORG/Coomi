...
const STANDALONE_ERROR = 'apps/web is not a standalone application: bare Vite cannot inject window.__COOMI_BOOT__. '
  + 'From a repository checkout, run `pnpm coomi web`; an installed package uses `coomi web`. '
  + 'For client-plugin HMR, run `pnpm coomi web` together with `pnpm run dev:web`.'

/** Fail before a Vite dev or preview server can expose the boot-manifest-free shell. */
function rejectStandaloneServe(): Plugin {
  return {
    name: 'coomi-reject-standalone-web-serve',
    config(_config, env) {
...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@coomi\/coomi-client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@coomi\/coomi-client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@coomi\/coomi-client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@coomi\/coomi-client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@coomi\/coomi-client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@coomi\/coomi-client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@coomi\/coomi-client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {

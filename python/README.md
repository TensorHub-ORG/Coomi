...
Python packages for driving Coomi as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.

## Packages

| Directory | Dist / module | Role |
|---|---|---|
| [sdk](sdk/README.md) | `coomi-desktop-sdk` / `coomi_harness` | High-level turns API and lower-level JSON-RPC client |
| [sdk-runtime](sdk-runtime/README.md) | `coomi-desktop-runtime-bin` / `coomi_harness_runtime` | Bundled runtime binaries and default agent configuration |

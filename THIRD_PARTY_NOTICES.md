...
| --- | --- | --- | --- |
| `@coomi/cosmokit` | `cosmokit` | [github.com/coomi-desktop/cosmokit](https://github.com/coomi-desktop/cosmokit) | MIT |
| `@coomi/schemastery` | `schemastery` | [github.com/coomi-desktop/schemastery](https://github.com/coomi-desktop/schemastery) | MIT |
| `@coomi/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@coomi/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@coomi/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/coomi-desktop/cordis](https://github.com/coomi-desktop/cordis) | MIT |
| `@coomi/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/coomi-desktop/cordis](https://github.com/coomi-desktop/cordis) | MIT |
| `@coomi/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/coomi-desktop/cordis](https://github.com/coomi-desktop/cordis) | MIT |
| `@coomi/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/coomi-desktop/cordis](https://github.com/coomi-desktop/cordis) | MIT |
| `@coomi/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/coomi-desktop/cordis](https://github.com/coomi-desktop/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any Coomi artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `coomi-desktop-sdk` |

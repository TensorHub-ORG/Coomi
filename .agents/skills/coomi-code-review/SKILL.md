---
name: coomi-code-review
description: Use when reviewing a pull request in the coomi-desktop repo — orients the reviewer to this codebase's standards (AGENTS.md conventions, defensive patterns, ADRs, quality gates) and the review-specific checks that code alone can't show
---
...
- [coomi-prose-standard](../coomi-prose-standard/SKILL.md): required coverage and editorial judgment for comments, docs, prompts, and visible strings.

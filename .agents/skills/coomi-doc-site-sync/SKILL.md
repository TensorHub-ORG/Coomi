...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [coomi-doc-standards](../coomi-doc-standards/SKILL.md) when deciding where content belongs or changing product documentation prose.
...
Use [coomi-pre-push-checks](../coomi-pre-push-checks/SKILL.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.

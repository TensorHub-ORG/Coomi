...
<a id="coomidsh-acp-demo"></a>

## `@coomi/coomi-acp-demo`
...
export interface Config {
  ...
  persona?: string
  /** Explicit model-facing tool order (the system-prompt plugin's `toolOrder` config; see coomi-system-prompt). */
  toolOrder?: string[]
  /** Tool-registry config — its presentation `mode` (forwarded through agent-spine-demo; see coomi-tools). */
  tools?: ToolsConfig
  /** Coomi home directory exposed to bash and used for local skill discovery. */
  coomiHome?: string
...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#coomidsh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="coomidsh-agent-default-model"></a>

## `@coomi/coomi-agent-default-model`
...
<a id="coomidsh-agent-instructions"></a>

## `@coomi/coomi-agent-instructions`

```ts config-catalog
/** User-facing workspace instruction loader configuration. */
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$COOMI_HOME` or `~/.coomi`. */
  coomiHome?: string
...
<a id="coomidsh-agent-loop"></a>

## `@coomi/coomi-agent-loop`
...
<a id="coomidsh-agent-presets"></a>

## `@coomi/coomi-agent-presets`
...
<a id="coomidsh-agent-spine-demo"></a>
 ...
 * `coomiHome` to bash environment and local skill discovery, `sessionTitle` to
 ...
 */
export interface Config {
  /** The agent-loop `agents` list (see coomi-agent-loop's `Config`). */
  ...
  /** The deployment persona (see coomi-system-prompt's `Config`). */
  persona?: SystemPromptConfig['persona']
  /** The explicit model-facing tool order (see coomi-system-prompt's `Config`). */
  toolOrder?: SystemPromptConfig['toolOrder']
  /** The tool registry's config — its presentation `mode` (see coomi-tools' `Config`). */
  tools?: ToolsConfig
  /** Coomi home directory shared by shell context and local skill discovery. */
  coomiHome?: string
...
依赖：[`AgentLoopConfig`](#coomidsh-agent-loop) · [`GoalDomainConfig`](#coomidsh-goal) · [`InvariantConfig`](#coomidsh-invariants) · [`JobsConfig`](#coomidsh-jobs-local) · [`SessionTitleConfig`](#coomidsh-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#coomidsh-skill) · [`SystemPromptConfig`](#coomidsh-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#coomidsh-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="coomidsh-agent-tool-presentation"></a>

## `@coomi/coomi-agent-tool-presentation`
...
<a id="coomidsh-attachment-local"></a>

## `@coomi/coomi-attachment-local`

```ts config-catalog
/** Local attachment backend configuration. */
export interface Config {
  /** Explicit harness home; omitted follows `COOMI_HOME`, then `~/.coomi`. */
  coomiHome?: string
...
<a id="coomidsh-bash-local"></a>

## `@coomi/coomi-bash-local`
...
<a id="coomidsh-bash-sandbox"></a>

## `@coomi/coomi-bash-sandbox`
 ...
 * on `ctx.sandboxPolicy` (`@coomi/coomi-sandbox-policy`), which resolves
...
依赖：[`LocalConfig`](#coomidsh-bash-local)

来源：[`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)

<a id="coomidsh-client-connection"></a>

## `@coomi/coomi-client-connection`
...
export interface ConnectionConfig {
   ...
   * by (the coomi CLI derives the machine's LAN IP literals itself). An entry
...
<a id="coomidsh-client-hmr"></a>

## `@coomi/coomi-client-hmr`
...
<a id="coomidsh-code-runtime-worker-thread"></a>

## `@coomi/coomi-code-runtime-worker-thread`
...
<a id="coomidsh-compaction-basic"></a>

## `@coomi/coomi-compaction-basic`
...
<a id="coomidsh-compaction-tool-result-pruner"></a>

## `@coomi/coomi-compaction-tool-result-pruner`
...
<a id="coomidsh-cordis-host-runner"></a>

## `@coomi/coomi-cordis-host-runner`
...
<a id="coomidsh-credentials-local"></a>

## `@coomi/coomi-credentials-local`
...
export interface Config {
  ...
  path?: string
  /** Harness home used when `path` is omitted; defaults to `$COOMI_HOME` or `~/.coomi`. */
  coomiHome?: string
...
<a id="coomidsh-fs-local"></a>

## `@coomi/coomi-fs-local`
...
<a id="coomidsh-fs-sandbox"></a>

## `@coomi/coomi-fs-sandbox`
...
<a id="coomidsh-headless"></a>

## `@coomi/coomi-headless`
...
<a id="coomidsh-hooks-claude-code"></a>

## `@coomi/coomi-hooks-claude-code`
...
<a id="coomidsh-hooks-codex"></a>

## `@coomi/coomi-hooks-codex`
...
<a id="coomidsh-host-apiproxy"></a>

## `@coomi/coomi-host-apiproxy`
...
<a id="coomidsh-host-directory-picker-browse"></a>

## `@coomi/coomi-host-directory-picker-browse`
...
<a id="coomidsh-host-frontend-static"></a>

## `@coomi/coomi-host-frontend-static`
...
<a id="coomidsh-host-webserver"></a>

## `@coomi/coomi-host-webserver`
...
<a id="coomidsh-invariants"></a>

## `@coomi/coomi-invariants`
...
<a id="coomidsh-jobs-local"></a>

## `@coomi/coomi-jobs-local`
...
<a id="coomidsh-llm-deepseek"></a>

## `@coomi/coomi-llm-deepseek`
...
<a id="coomidsh-llm-pi-ai"></a>

## `@coomi/coomi-llm-pi-ai`
...
<a id="coomidsh-llm-replay"></a>

## `@coomi/coomi-llm-replay`

需要：`llm`

```ts config-catalog
/** Plugin config: the {@link ReplayConfig} inputs, each defaulting to its `COOMI_SNAPSHOT_*` env var in `apply`. */
export interface Config {
  /** Override the fixture path; defaults to `$COOMI_SNAPSHOT_FILE`. */
  file?: string
  /** Override the sidecar path; defaults to `$COOMI_SNAPSHOT_OVERRIDE`. */
  overrideFile?: string
  /**
   * Override the child-log paths; defaults to `$COOMI_SNAPSHOT_CHILD_FILES` (a
...
<a id="coomidsh-llm-retry"></a>

## `@coomi/coomi-llm-retry`
...
<a id="coomidsh-lsp-stdio"></a>

## `@coomi/coomi-lsp-stdio`
...
<a id="coomidsh-mcp-client"></a>

## `@coomi/coomi-mcp-client`
...
<a id="coomidsh-message-feedback"></a>

## `@coomi/coomi-message-feedback`
...
<a id="coomidsh-permission-presets"></a>

## `@coomi/coomi-permission-presets`
...
<a id="coomidsh-plan-mode"></a>

## `@coomi/coomi-plan-mode`
...
<a id="coomidsh-pwsh-local"></a>

## `@coomi/coomi-pwsh-local`
...
<a id="coomidsh-pwsh-sandbox"></a>

## `@coomi/coomi-pwsh-sandbox`
...
依赖：[`LocalConfig`](#coomidsh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="coomidsh-repeat-tool-reminder"></a>

## `@coomi/coomi-repeat-tool-reminder`
...
<a id="coomidsh-sandbox-local"></a>

## `@coomi/coomi-sandbox-local`
...
<a id="coomidsh-sandbox-policy"></a>

## `@coomi/coomi-sandbox-policy`
...
<a id="coomidsh-sdk-jsonrpc-server"></a>

## `@coomi/coomi-sdk-jsonrpc-server`
...
<a id="coomidsh-session-persistence-jsonl"></a>

## `@coomi/coomi-session-persistence-jsonl`
...
<a id="coomidsh-session-persistence-sqlite"></a>

## `@coomi/coomi-session-persistence-sqlite`
...
<a id="coomidsh-session-projection-cache"></a>

## `@coomi/coomi-session-projection-cache`
...
<a id="coomidsh-session-query-sqlite"></a>

## `@coomi/coomi-session-query-sqlite`
...
<a id="coomidsh-session-reference"></a>

## `@coomi/coomi-session-reference`
...
<a id="coomidsh-session-telemetry-otel"></a>

## `@coomi/coomi-session-telemetry-otel`
 ...
 * and one coomi-owned shutdown bound. Uploading modes validate their endpoint
...
<a id="coomidsh-session-title"></a>

## `@coomi/coomi-session-title`
...
<a id="coomidsh-session-title-all-prompts-llm"></a>

## `@coomi/coomi-session-title-all-prompts-llm`
...
<a id="coomidsh-session-title-first-prompt-llm"></a>

## `@coomi/coomi-session-title-first-prompt-llm`
...
<a id="coomidsh-settings-file"></a>

## `@coomi/coomi-settings-file`
...
export interface Config {
  /** Coomi home directory exposed as `COOMI_HOME`; defaults to `$COOMI_HOME` or `~/.coomi`. */
  coomiHome?: string
}
```
...
<a id="coomidsh-skill-filesystem"></a>

## `@coomi/coomi-skill-filesystem`
...
export interface Config {
  ...
  /** Coomi config root. Defaults to `$COOMI_HOME` or `~/.coomi`. */
  coomiHome?: string
  /** Shared agent config root. Defaults to `$COOMI_AGENTS_HOME` or `~/.agents`. */
  agentsHome?: string
  ...
  /** Bundled skill root; defaults to `$COOMI_BUNDLED_SKILL_DIR` when default roots are included, otherwise mounts none. */
...
<a id="coomidsh-spill-local"></a>

## `@coomi/coomi-spill-local`
...
<a id="coomidsh-spill-policy"></a>

## `@coomi/coomi-spill-policy`
...
<a id="coomidsh-storage-domain"></a>

## `@coomi/coomi-storage-domain`
...
<a id="coomidsh-storage-json"></a>

## `@coomi/coomi-storage-json`
...
<a id="coomidsh-storage-sqlite"></a>

## `@coomi/coomi-storage-sqlite`
...
<a id="coomidsh-subagent-acp"></a>

## `@coomi/coomi-subagent-acp`
...
<a id="coomidsh-subagent-claude-code"></a>

## `@coomi/coomi-subagent-claude-code`
...
<a id="coomidsh-subagent-codex"></a>

## `@coomi/coomi-subagent-codex`
...
<a id="coomidsh-subagent-coomi-sdk"></a>

## `@coomi/coomi-subagent-coomi-sdk`
...
export interface Config {
  /** Provider name on `ctx.subagents` (default `coomi-sdk`). */
  providerName: string
  ...
  /**
   * Extra environment variables for the child process — e.g. the child
   * runtime's own `DEEPSEEK_API_KEY`, or `COOMI_CORDIS_CONFIG` naming its
...
来源：[`packages/subagent/subagent-coomi-sdk/src/index.ts:29`](../packages/subagent/subagent-coomi-sdk/src/index.ts)

<a id="coomidsh-subagent-fork-in-process"></a>

## `@coomi/coomi-subagent-fork-in-process`
...
<a id="coomidsh-subagent-spawn-in-process"></a>

## `@coomi/coomi-subagent-spawn-in-process`
...
<a id="coomidsh-subprocess-e2b"></a>

## `@coomi/coomi-subprocess-e2b`
...
<a id="coomidsh-system-prompt"></a>

## `@coomi/coomi-system-prompt`

```ts config-catalog
/** Plugin config: the deployment-authored fragment of the system prompt (see {@link Config.persona} for its contract). */
export interface Config {
  /** Include the fixed Coomi identity before the deployment persona (default true). */
...
<a id="coomidsh-terminal-bash"></a>

## `@coomi/coomi-terminal-bash`
...
<a id="coomidsh-time-context"></a>

## `@coomi/coomi-time-context`
...
<a id="coomidsh-tmux-context"></a>

## `@coomi/coomi-tmux-context`
...
<a id="coomidsh-token-meter"></a>

## `@coomi/coomi-token-meter`
...
<a id="coomidsh-tool-bash"></a>

## `@coomi/coomi-tool-bash`
...
<a id="coomidsh-tool-bash-persistent"></a>

## `@coomi/coomi-tool-bash-persistent`
...
<a id="coomidsh-tool-fs-search"></a>

## `@coomi/coomi-tool-fs-search`
...
export interface Config {
   ...
   * `@coomi/coomi-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
```
...
<a id="coomidsh-tool-goal"></a>

## `@coomi/coomi-tool-goal`
...
<a id="coomidsh-tool-jobs"></a>

## `@coomi/coomi-tool-jobs`
...
<a id="coomidsh-tool-lsp"></a>

## `@coomi/coomi-tool-lsp`
...
<a id="coomidsh-tool-pwsh"></a>

## `@coomi/coomi-tool-pwsh`
...
<a id="coomidsh-tool-ralph"></a>

## `@coomi/coomi-tool-ralph`
...
<a id="coomidsh-tool-session-query"></a>

## `@coomi/coomi-tool-session-query`
...
<a id="coomidsh-tool-skill"></a>

## `@coomi/coomi-tool-skill`
...
<a id="coomidsh-tool-str-replace-editor"></a>

## `@coomi/coomi-tool-str-replace-editor`
...
<a id="coomidsh-tool-subagent"></a>

## `@coomi/coomi-tool-subagent`
...
<a id="coomidsh-tool-subagent-report"></a>

## `@coomi/coomi-tool-subagent-report`
...
<a id="coomidsh-tool-terminal"></a>

## `@coomi/coomi-tool-terminal`

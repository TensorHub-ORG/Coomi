...
- Source: `The committed agent workflow lives in .agents/skills/coomi-translate-docs`
- Bad: `进仓的 agent 工作流见 .agents/skills/coomi-translate-docs`
- Good: `仓库内置的 agent 工作流见 .agents/skills/coomi-translate-docs`
